...
public class HL7RAD2 extends HL7Message {

	/**
	 * Create an ORM message.
	 */
	public HL7RAD2() {
		super("RAD2(ORM)");
...
//			orc.setField( 5,"SC");
	...
	public HL7Segment setOBX(
				...
				String units) {
		HL7Segment obx = new HL7Segment("OBX");
		if (obx != null) {
			obx.setField( 2, valueType);
			obx.setField( 3, observationIdentifier);
			obx.setField( 5, observationValue);
