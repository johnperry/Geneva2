...
public class HL7RAD28 extends HL7Message {

	/**
	 * Create an ORU message.
	 */
	public HL7RAD28() {
		super("RAD28(ORU)");
	...
	public HL7Segment setOBR(
		...
		if (obr != null) {
			...
			obr.setField(22,dateTime);
			obr.setField(24,diagnosticServiceID);
			obr.setField(25,"F");			// Ordered
			obr.setField(27,"1^once^^^^S");
			obr.setField(30,"WALK");
			obr.setField(32,"^SIGNER^K");
			obr.setField(35,"^TRANSCRIBER^L");
			obr.setField(41,"A");
	...
	public HL7Segment setOBX(
				String setID,
				String reportText) {
		HL7Segment obx = getSegment("OBX");
		if (obx != null) {
			obx.setField( 1,setID);
			obx.setField( 5,reportText);
		}
		return obx;
	}
