...
public class RegistrationXml {
	...
	String assigningAuthority = new String("");
	...
	assigningAuthority = new String(s);
    ...
    public String getAssigningAuthorityOIDOnly( ) {
      String x = new String(assigningAuthority);
System.out.println("<" + x + ">");
      if (x.startsWith("&amp;")) x = x.substring(5);
