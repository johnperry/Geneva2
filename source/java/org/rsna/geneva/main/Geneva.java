...
public class Geneva extends JFrame implements RegSysListener {
	 ...
	 */
    public Geneva() {
	System.out.println("Geneva constructor");
		...
		Users users = Users.getInstance("org.rsna.server.UsersXmlFileImpl", (Element)null);
		for (String role : userRoles) users.addRole(role);
	...
	class MainPanel extends JPanel implements ChangeListener {
		...
		public MainPanel(StatusPanel statusPanel,
			...
			tabbedPane.addTab("Batch Reg", batchPanel);
